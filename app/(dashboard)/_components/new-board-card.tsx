...
function NewBoardCard({ organizationId }: NewBoardCardProps) {
  ...
  return (
    <div className="group aspect-[100/127] grid place-items-center border-2 border-dashed border-accent rounded-box bg-base-300 hover:border-opacity-75">
      <button onClick={createBoard} className="cursor-pointer w-full h-full">
        <div className="inline-flex items-center justify-center flex-col gap-y-4">
          <Plus size={40} weight="bold" className="text-primary" />
          <h1 className="text-base-content font-semibold">New Board</h1>
        </div>
      </button>
    </div>
  );
